...
--
-- Počítač: 127.0.0.1
-- Vygenerováno: Ned 03. lis 2013, 06:13
-- Verze MySQL: 5.5.27
-- Verze PHP: 5.4.7
...
--
-- Struktura tabulky `map_particles`
--

CREATE TABLE IF NOT EXISTS `map_particles` (
  `map_id` smallint(6) NOT NULL,
  `particle_id` int(11) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=ascii;

--
-- Vypisuji data pro tabulku `map_particles`
--

INSERT INTO `map_particles` (`map_id`, `particle_id`) VALUES
(1, 1);
...
) ENGINE=MyISAM  DEFAULT CHARSET=ascii AUTO_INCREMENT=17 ;
...
--
-- Struktura tabulky `particles`
--

CREATE TABLE IF NOT EXISTS `particles` (
  `particle_id` int(11) NOT NULL AUTO_INCREMENT,
  `particle_image` varchar(100) NOT NULL,
  PRIMARY KEY (`particle_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=ascii AUTO_INCREMENT=2 ;

--
-- Vypisuji data pro tabulku `particles`
--

INSERT INTO `particles` (`particle_id`, `particle_image`) VALUES
(1, 'ParticleSmoke.png');
...
CREATE TABLE IF NOT EXISTS `tiles` (
  ...
  PRIMARY KEY (`tile_id`),
  KEY `map_id` (`map_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=ascii AUTO_INCREMENT=1037 ;
