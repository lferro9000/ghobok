			...
			$(".select-button", manager.contents()).each( 
				function(i, e) {
					$(e).click( function () {
						...
						editor.map_object.positionZ = parseInt(object_json.default_position_z);
						editor.map_object.rotationX = parseFloat(object_json.default_rotation_x);
						editor.map_object.rotationY = parseFloat(object_json.default_rotation_y);
						editor.map_object.rotationZ = parseFloat(object_json.default_rotation_z);
						editor.map_object.scale = parseFloat(object_json.default_scale);
